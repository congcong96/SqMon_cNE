function [AssemblyTemplates, CorrMatrix] = sm_assembly_patterns(SpikeCount, dt, opts)
...
% get correlation matrix from STTC
CorrMatrix = STTC(SpikeCount', 'dt', dt);
CorrMatrix(isnan(CorrMatrix))=0;
[eigenvectors,d] = eig(CorrMatrix);
eigenvalues=diag(d);

q = size(SpikeCount,1)/size(SpikeCount,2);
